from jmeter_api.post_processors.re_extractor.elements import RegExpPost, RegExpPostXML, Scope, Field
...
class TestRegExpPostXML:
    def test_render_testname(self):
        element = RegExpPostXML(name='My reg exp')
